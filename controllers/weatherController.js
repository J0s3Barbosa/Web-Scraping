...
function Itacoatiara48forecast() {
  const urlItacoatiaraforecast = 'http://pt.surf-forecast.com/breaks/Itacoatiara/forecasts/latest';
  return new Promise(function (resolve, reject) {
    request(urlItacoatiaraforecast, function (err, response, body) {
      ...
      let day1 = $('.day-end').eq(0).text()
      let day2 = $('.day-end').eq(1).text()
      let day3 = $('.day-end').eq(2).text()
      ...
      channels.push({ days, uniqueweather, wavesTimes });
      resolve(channels);
